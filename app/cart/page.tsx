            ...
            >
              ...
              {products.length > 0 && (
                <div className="mt-6">
                  <Link
                    href="/checkout"
                    className="flex justify-center items-center w-full uppercase bg-white px-4 py-3 text-base border border-black font-bold text-blue-600 shadow-sm hover:bg-black focus:outline-none focus:ring-2"
                  >
                    <span>Checkout</span>
                  </Link>
                </div>
